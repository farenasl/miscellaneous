...
public interface CountryDocumentIDTypeRepository extends CrudRepository<CountryDocumentIDTypeDTO, Integer> {
    List<CountryDocumentIDTypeDTO> findAllByCountry(CountryDTO country);
}